...
## SET-UP DATASET
datafolder = "./train_output/" if args.set == "train" else "./test_output/"
n_Samples_test = int(args.dataTest)
n_Cons_small = 855 # Each LP has 10 constraints
n_Vars_small = 1071 # Each LP has 50 variables
n_Eles_small = 5037 # Each LP has 100 nonzeros in matrix A
